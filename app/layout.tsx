...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Projitt-website-admin',
    template: '%s | Projitt-website-admin',
  },
  description: 'Generated by create next app',
  keywords: ['HR management', 'recruitment', 'payroll', 'employee management', 'talent management', 'HRMS', 'human resources'],
  authors: [{ name: 'Projitt-website-admin' }],
  creator: 'Projitt-website-admin',
  publisher: 'Projitt-website-admin',
  formatDetection: {
    email: false,
    address: false,
    telephone: false,
  ...
  openGraph: {
    ...
    locale: 'en_US',
    url: '/',
    siteName: 'Projitt-website-admin',
    title: 'Projitt-website-admin',
    description: 'Generated by create next app',
    images: [
      {
        url: '/images/logo.png',
